...
<script language="javascript" type="text/javascript" src="My97DatePicker/WdatePicker.js"></script>
    ...
    <table style="text-align:center;margin-top:45.5%;width: 80%;margin-left:10%">
     <form action="cx.jsp" method="post" autocomplete="off">
 </tr>
   <tr><td colspan="10"> <button type="submit" class="submit_button" />点击查看看板</button></td></tr></form>
   </table>
</body>
</html>
